    ...
    <>
      ...
      <section className="relative flex min-h-screen items-center overflow-hidden px-8 pt-24">
        ...
        <div className="mx-auto w-full max-w-6xl">
          ...
          <a
            href="#about"
            className="absolute bottom-6 left-1/2 hidden -translate-x-1/2 translate-y-20 text-center text-xs uppercase tracking-[0.25em] text-neutral-400 transition hover:text-[#b57967] md:block"
